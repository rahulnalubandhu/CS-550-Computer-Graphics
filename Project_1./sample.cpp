...
Display( )
{
	...
	DoRasterString( 3.f, 3.f, 0.f, (char *)"934388142" );
	...
	DoRasterString( 5.f, 5.f, 0.f, (char *)"Rahul.N" );
...
void InitLists( )
{
    ...
    //     //back
	 ...
	 glBegin(GL_LINES);
	 for (GLfloat k = -4.0;k <= 4.0; k += 0.25) {
			glVertex3f(k, -3.0, 4.0); 
			glVertex3f(k, -3.0, -4.0);
			glVertex3f(4.0, -3.0, k); 
			glVertex3f(-4.0, -3.0, k);
	 }
	 glEnd();
