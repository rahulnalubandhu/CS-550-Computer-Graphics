...
const char *WINDOWTITLE = { "Project_5" };
...
Display( )
{
    ...
    // glScalef( (GLfloat)Scale, (GLfloat)Scale, (GLfloat)Scale );
        glScalef((GLfloat)1.69f, (GLfloat)1.69f, (GLfloat)1.69f);
...
InitGraphics( )
{
    ...
    bool valid = Pattern->Create( "/Users/nalubanr/Documents/CS550/Assignment5/P5/pattern.vert","/Users/nalubanr/Documents/CS550/Assignment5/P5/pattern.frag" );
    if( ! valid )
    {
...
InitLists( )
{
    ...
    SetMaterial(0., 0., 0., 1.);
    LoadObjFile( (char *)"mustang_GT.obj" );
