...
const char *WINDOWTITLE = { "Project_4 - Yi-Jung Chiang" };
...
Display( )
{
    ...
    //light0
    SetSpotLight(GL_LIGHT0, 0, 0., 0, 0, 0., 10, 1., 0., 0.);
    glPushMatrix();
    glDisable(GL_LIGHTING);
    glColor3f(1., 0, 0);
    ...
    //light1
    SetPointLight(GL_LIGHT1, 0., 0., 9., 1., 1., 1);
    glPushMatrix();
    glDisable(GL_LIGHTING);
    glColor3f(1., 1., 1.);
    glTranslatef(0, 0., 9);
    ...
    glDisable(GL_LIGHTING);
    glColor3f( 1., 1., 1. );
    DoRasterString( 5., 5., 0., "Yi-Jung Chiang" );
